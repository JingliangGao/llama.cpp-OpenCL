# llama.cpp/example/simple-override-moe

## Description
The purpose of this example is to demonstrate a minimal usage of llama.cpp for generating text with a given prompt and override the number of MOE groups.
...
```bash
./llama-simple-override-moe -m ./models/llama-7b-v2/ggml-model-f16.gguf "Hello my name is"
