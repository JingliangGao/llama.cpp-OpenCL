...
static void print_usage(int, char ** argv) {
    printf("\nexample usage:\n");
    printf("\n    %s -m model.gguf  [-oe n_expert_override] [-nls n_layer_skip] [prompt]\n", argv[0]);
    printf("\n");
}
...
int main(int argc, char ** argv) {
    ...
    /*  MoE Override context parameters     JingliangGao 2026/06/18 */
    ctx_params.n_expert_override = n_expert_override;    /* override the number of MoE experts  */
    ctx_params.n_layer_skip = n_layer_skip;              /* skip N layers (default: %d, 0 = compute all layers) for layer freeze computation */
