...
/* add profiler header   JingliangGao 2026/06/24 */
...
#if defined(GGML_UNIFY_PROFILER)
    /* add Profiler state    JingliangGao 2026/06/24 */
...
#if defined(GGML_UNIFY_PROFILER)
    /* Callback function for recording CPU profiling events from C code (ggml-cpu.c)    JingliangGao 2026/06/24 */
...
#if defined(GGML_UNIFY_PROFILER) 
    /* Set up profiling callback if profiling is enabled    JingliangGao 2026/06/24 */
...
#if defined(GGML_UNIFY_PROFILER) 
    /* Register profiler    JingliangGao 2026/06/24 */
